        ...
        <div className="flex h-20 items-center justify-between">
          ...
          >
            ...
            {mobileMenuOpen ? (
              ...
              <svg className="h-6 w-6" f
cd /workspaces/therabrakeacademy/apps/web

# 1. Check the current structure
ls -la src/components/layout/

# 2. Remove ALL existing header/footer files to start clean
rm -f src/components/layout/Header.*
rm -f src/components/layout/Footer.*
rm -f src/components/layout/header.*
rm -f src/components/layout/footer.*

# 3. Create clean TypeScript versions (using .tsx for Next.js consistency)
