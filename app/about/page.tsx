...
import { GraduationCap, Brain, Target, Users, Award, BookOpen } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-primary/5">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Mission Statement */}
          <div className="bg-gradient-to-r from-primary to-secondary rounded-xl p-8 text-white text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <BookOpen className="w-10 h-10 text-action mx-auto mb-3" />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/courses" 
              className="px-8 py-3 bg-primary hover:bg-primary-hover text-white rounded-lg font-medium transition-all duration-200"
            >
              Browse Courses
            </Link>
            <Link 
              href="/contact" 
              className="px-8 py-3 bg-secondary hover:bg-secondary-light text-white rounded-lg font-medium transition-all duration-200"
            >
              Contact Us
            </Link>
          </div>
